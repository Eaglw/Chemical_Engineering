...
6. Low T gradient, so $\rho$ is constant and the deviatoric part of the [[Stress tensor|stress tensor]] expressed as a [[Advanced Transport Phenomena/Costitutive eq. for Newtornian fluids|costitutive eq. for Newtornian fluids]] is zero.
