...
With the [[Principle of Virtual Works (PLV)|PLV]] is possible to resolve a [[Structure Engineering/3. Basic/Determinate structure|determinate structure]], knowing the supports reactions and the internal characteristic of solicitations.
